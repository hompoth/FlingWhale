...
public class Menu : MonoBehaviour
{
    ...
    public static readonly string SceneNameMenu = "Menu-Scene";
    ...
    public void OnGUI()
    {
		...
		if (!PhotonNetwork.connected) {
			...
			if (this.connectFailed) {
				...
				if (GUILayout.Button ("Try Again", GUILayout.Width (150))) {
					this.connectFailed = false;
					PhotonNetwork.ConnectUsingSettings ("0.9");
				}
				if (GUILayout.Button ("Offline Mode", GUILayout.Width (150))) {
					this.connectFailed = false;
		...
		if (PhotonNetwork.offlineMode) {
			GUILayout.BeginHorizontal ();
			GUILayout.FlexibleSpace ();
			if (GUILayout.Button ("Online Mode", GUILayout.Width (150))) {
